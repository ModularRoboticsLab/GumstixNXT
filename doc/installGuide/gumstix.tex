...
%
\begin{itemize}
\item From revision 1.4.2: removed hardware issues warning, added
  instructions for setting up GPIO 31
\item From revision 1.4.1: added warning about current hardware issues
\item From revision 1.4.0: added warning about untested motor driver instructions
