...
Revision 2.0.2 (\today): cleaned up for new iteration of the course, enough checked and verified
...
\begin{verbatim}
cp tmp/work/overo-angstrom-linux-gnueabi/linux-omap3-3.2-r103/git/.config org.openembedded.dev/recipes/linux/linux-omap3-2.6.37-psp04.01.00.03/defconfig
